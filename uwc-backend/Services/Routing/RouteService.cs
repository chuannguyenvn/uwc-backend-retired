...
{
    public (bool success, object result) AddRoute(string name, double totalLength,
        string routeDetails);

    public (bool success, object result) UpdateRoute(int id, string name, double totalLength,
        string routeDetails);
}
...
public class RouteService : IRouteService
{
    ...
    public (bool success, object result) AddRoute(string name, double totalLength,
        string routeDetails)
    {
        var routeInformation = new Route
        {
            RouteName = name, TotalLength = totalLength, RouteDetails = routeDetails
        };
